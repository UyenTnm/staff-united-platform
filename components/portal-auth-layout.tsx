...
export function PortalAuthLayout({ children }: PortalAuthLayoutProps) {
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-slate-900 to-brand-900 px-4 py-10">
