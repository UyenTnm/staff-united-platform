...
export default function NewKaizenPage() {
  ...
  useEffect(() => {
    async function loadKaizen() {
      ...
      if (kaizen.employee_id !== employee.id) {
        toast.error("You are not authorized to edit this Kaizen.");
        router.replace("/performance/kaizen");
        return;
      }

      if (kaizen.status !== "Draft") {
        toast.error("Only draft Kaizens can be edited.");
        router.replace("/performance/kaizen");
        return;
      }
    ...
    loadKaizen();
  }, [employee, params.kaizenId, router]);
        ...
        <div className="flex justify-between">
          <div>
            ...
            <p className="text-slate-500 mt-2">
              Continue editing your Kaizen before submitting it.
            </p>
          </div>
